...
void FunctionTest::Test( )
{
	...
	std::istringstream istr( std::string(Begin(bytes), End(bytes)) ) ;
	
	std::stringstream ss ;
	ss <<	"<</BitsPerSample 8/Domain [0 1]/Filter /FlateDecode"
			"/FunctionType 0/Length 271/Range [0 1]/Size [256]>>" ;
	Dictionary sdict ;
	CPPUNIT_ASSERT( ss >> sdict ) ;
	
	Object sfunc( Stream( istr.rdbuf(), 0, sdict ) ) ;
	MockFile file ;

...
#ifndef __PDF_REALTEXTLINE_HEADER_INCLUDED__
#define __PDF_REALTEXTLINE_HEADER_INCLUDED__
...
*/
class RealTextLine : public TextLine
{
public :
	explicit RealTextLine(
	...
	bool operator==( const RealTextLine& rhs ) const ;
	bool operator!=( const RealTextLine& rhs ) const ;
	...
	*/
	...
	friend std::ostream& operator<<( std::ostream& os, const RealTextLine& t ) ;

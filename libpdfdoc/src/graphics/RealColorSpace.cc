...
*/
RealColorSpace::RealColorSpace( Color::Space sp )
	: m_space( sp )
{
}
...
Color RealColorSpace::Lookup( unsigned val ) const
{
...
Color::Space RealColorSpace::Get() const
{
	return m_space ;
}

Color::Space RealColorSpace::NameToSpace( const std::string& name )
{
	if ( name == "DeviceGray" )
		return Color::gray ;
